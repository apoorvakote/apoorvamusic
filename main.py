...
statusbar = ttk.Label(root, text="Welcome to Apoorva Music Player", anchor=W, font='Arial 8  bold italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Apoorva Music Player", anchor=W, font='Arial 8 bold italic')
...
root.title("apoorva Music Player") 
ltframe = Frame(root,bg="#9160a5")
ltframe.pack(side=LEFT, padx=30, pady=30)
songplaylistcontainer = Listbox(ltframe,fg='white')
songplaylistcontainer["bg"]="#9160a5"
...
rtframe = Frame(root,bg="#9160a5")
rtframe.pack(pady=30,padx=20)
topframe = Frame(rtframe,bg="#9160a5")
topframe.pack()
root.style = ttk.Style()
#root.style.theme_use("clam")
root.style.configure('TLabel', background='#9160a5')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found', 'apoorva music player could not find the file. Please select again.')
def stop_music():
    mixer.music.stop()
...
def mute_music():
    ...
    if muted:
        ...
        scale.set(0)
        muted = TRUE
middleframe = Frame(rtframe,bg="#9160a5")
...
bottomframe = Frame(rtframe,bg="#9160a5")
